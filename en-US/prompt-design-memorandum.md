...
### 7.6 The Effect of In-Field Blank Lines
...
- Stance language (restated warnings, pre-emptive disclaimers, commitment sentences, "left open") rose from near zero to multiple occurrences.Constructive-type products reduced; coverage-type products held level.
